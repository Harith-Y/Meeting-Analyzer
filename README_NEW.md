...
- 📚 Best for important lectures with complex content
...
### For Long Lectures (1-2 hours)

1. **Use Parakeet model** for faster processing
2. **Good internet connection** required (uses cloud API)
3. **Expected processing time**: 
   - Parakeet: ~1.5x of audio length
   - Whisper: ~2.5x of audio length
4. **Be patient**: A 1.5-hour lecture may take 2-4 hours total
...
A: Currently one at a time in the UI. Batch processing can be added by creating a script that calls the modules directly.

**Q: How accurate is the transcription?**
A: Very good with clear audio. Whisper model achieves 90-95% accuracy with good recordings. Parakeet is 85-90%.
